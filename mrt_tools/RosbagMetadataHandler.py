...
class RosbagMetadataHandler(object):
    ...
    Metadata takes the form of key-value pairs. Metadata can be nested in subcategories. The METADATA_TEMPLATE file
    specifies the minimal set of fields that have to be specified, but user defined fields can be added as desired.
    The data is stored in the topic "/metadata" of type std_msgs/String inside the rosbag. Additionally, a yaml file
    hold
    """
